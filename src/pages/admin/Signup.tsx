...
import { Eye, EyeOff, Mail, Lock, ArrowRight, User, Phone, Check, X, Shield } from "lucide-react";
    ...
    try {
      ...
      if (error) {
        ...
        if (error.message?.includes('duplicate key')) {
          ...
          errorMessage = "Permission denied. Please run the database schema updates first.";
      ...
      toast({
        title: "Signup Failed",
        description: error.message || "An error occurred during admin signup.",
        variant: "destructive"
      });
    }
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
        <div className="w-full max-w-lg bg-white/5 backdrop-blur-xl rounded-[2.5rem] border border-white/15 shadow-2xl p-8 flex flex-col items-center gap-6">
          ...
          <div className="text-center">
            ...
            <p className="text-white/70 text-sm">Create your admin account to access the dashboard</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4">
            ...
            <p className="text-white/60 text-sm text-center mt-2">
              ...
              <Link to="/admin/login" className="text-cyan-400 hover:text-cyan-300 font-medium">
                Sign in
              </Link>
            </p>
          </form>
